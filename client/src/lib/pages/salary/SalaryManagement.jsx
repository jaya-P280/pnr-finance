...
export default function SalaryManagement() {
  ...
  const pName = pUser ? `${pUser.first_name || pUser.firstName || ""} ${pUser.last_name || pUser.lastName || ""}`.trim() : "Employee";
  const pEmpCode = pUser?.employee_code || pUser?.employeeCode || "EMP001";
