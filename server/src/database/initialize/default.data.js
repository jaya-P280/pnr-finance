...
export const DEFAULT_PERMISSIONS = [
  ...
  {
    permission_name: "TASK_VIEW",
    module_name: "TASK",
    description: "View field tasks",
  },
  {
    permission_name: "TASK_CREATE",
    module_name: "TASK",
    description: "Create field tasks",
  },
  {
    permission_name: "TASK_UPDATE",
    module_name: "TASK",
    description: "Update field tasks",
  },
  {
    permission_name: "TASK_DELETE",
    module_name: "TASK",
    description: "Delete field tasks",
  },
  {
    permission_name: "FINANCE_VIEW",
    module_name: "FINANCE",
    description: "View cash book, income, and expenses",
  },
  {
    permission_name: "FINANCE_CREATE",
    module_name: "FINANCE",
    description: "Record income and expenses",
  },
  {
    permission_name: "FINANCE_DELETE",
    module_name: "FINANCE",
    description: "Delete income and expenses",
  },
];
