  ...
  async createLoanProduct(data, currentUser) {
    ...
    try {
      ...
      const loanProductId = await loanProductRepository.create(connection, {
        ...
        productType: data.productType || "TERM_LOAN",
        ...
        processingFeeType: data.processingFeeType || "PERCENTAGE",
        processingFee: data.processingFee ?? 0,
        insuranceFeeType: data.insuranceFeeType || "FIXED",
        insuranceFee: data.insuranceFee ?? 0,
        penaltyType: data.penaltyType || "FIXED",
        penalty: data.penalty ?? 0,
        holidayExcluded: Boolean(data.holidayExcluded),
